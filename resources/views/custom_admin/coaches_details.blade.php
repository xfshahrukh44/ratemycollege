                ...
                <table id="examplee" class="table" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <?php if($val_coach_change->id != ""){ echo App\Models\Wp_coach::find($val_coach_change->id)->name; } ?> </td>
                      <td> <?php if($val_coach_change->school_id != ""){ echo App\Models\Wp_school::find($val_coach_change->school_id)->name; } ?> </td>
                      <td> <?php if($val_coach_change->sports_id != ""){ echo App\Models\Wp_sport::find($val_coach_change->sports_id)->name; } ?> </td>
                      
                      <td> <?php if($val_coach_change->old_coach_id != ""){ echo App\Models\Wp_coach::find($val_coach_change->old_coach_id)->name; } ?> </td>
                      <td> <?php if($val_coach_change->old_school_id != ""){ echo App\Models\Wp_school::find($val_coach_change->old_school_id)->name; } ?> </td>
...
<script>
    ...
    $('#coach').change(function(){
        ...
        var url = '{{ URL("admin/coachesdetails") }}';
