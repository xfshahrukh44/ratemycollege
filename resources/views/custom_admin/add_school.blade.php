                          ...
                          <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                               ...
                               <form method="post" action="{{ route('post_add_school') }}">
                                   ...
                                   @csrf
                                    ...
                                    <br>
                                     ...
                                     <select id="single3" class="form-control" name="sports_id[]" multiple>
                                         @foreach($get_sports as $key => $val_sport)
                                         <option value="{{ $val_sport->id }}"> {{ $val_sport->name }} </option>
                                         @endforeach
                                     </select>
                                   
                                    <br><br><br>
                                    
                                    <input type="submit" class="btn btn-danger" value="ADD NEW SCHOOL" />
