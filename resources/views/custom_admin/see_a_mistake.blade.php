                        ...
                        <div class="table-border">
                             ...
                             <table id="examplee" class="table" >
                               ...
                               <tbody>
                                ...
                                @foreach($get_see_a_mistake as $key => $val_mistake)
                                <tr>
                                  
                                  <td> {{ $key+1 }} </td>
                                  <td> {{ \App\Models\Wp_sport::find($val_mistake->sport_id)->name }} </td>
                                  <td> {{ $val_mistake->new_coach_id }} </td>
                                  <td> {{ $val_mistake->email }} </td>
                                  <td> {{ $val_mistake->created_at }} </td>
