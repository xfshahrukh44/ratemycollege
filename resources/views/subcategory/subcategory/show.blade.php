      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top:25px;">
                <div class="card">
                    <div class="card-header bg-info">Subcategory {{ $subcategory->id }}</div>
                    <div class="card-body">

                        <a href="{{ url('/admin/subcategory') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                        <a href="{{ url('/admin/subcategory/' . $subcategory->id . '/edit') }}" title="Edit Subcategory"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                            ...
                            <table class="table table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th> Image </th>
                                        <td>
                                            <img src="{{ ($subcategory->image != null) ? asset($subcategory->image) : asset('no_image.png') }}" style="height: 75px;width: 120px;border: 1px solid #000;border-radius: 10px;" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
